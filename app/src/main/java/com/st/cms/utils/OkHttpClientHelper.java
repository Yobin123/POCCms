...
public class OkHttpClientHelper {
     ...
     * @return
     */
//    public static String postKeyValuePairByte(Context context,String urlString,Map<String,byte[]>map,Object tag){
//        //往FormEncodingBuilder对象中放置键值对
//        FormEncodingBuilder formBuilder = new FormEncodingBuilder();
//        if (map != null && !map.isEmpty()) {
...
//    }
    ...
    public static void postKeyValuePairAsync(Context context, String urlString, Map<String,
        ...
        if (map != null && !map.isEmpty()) {
            for (Map.Entry<String, String> entry : map.entrySet()) {
                formBuilder.add(entry.getKey(), entry.getValue());
                Log.i("----->>>", "postKeyValuePairAsync: "+entry.getKey()+"fasfa"+entry.getValue());
            }
        }
        //生成请求体对象
        RequestBody requestBody = formBuilder.build();
...
//
///////////////////////////////////////////////////////////////////////////
    public static void postKeyValuePairByteAsync(Context context,String urlString,Map<String,byte[]> map,Callback callback,Object tag){
//        MediaType MEDIA_TYPE_MARKDOWN
//                = MediaType.parse("text/x-markdown; charset=utf-8");
//        for (Map.Entry<String, byte[]> entry : map.entrySet()) {
//            RequestBody requestBody = RequestBody.create(MediaType.parse("application/octet-stream"), entry.getKey());
//        }
     ...
     * @param tag
     */
//    public static void postUploadFileAsync(Context context,String urlString,String tagId,byte[] bytes,Callback callback,Object tag){
//
////            RequestBody requestBody = getOkHttpClientUtils(context).buildRequestBody(tagId,)
//
//    }
...
//     * @return
//     */
//    private RequestBody buildRequsetBody(String tagId,File file){
//        MultipartBuilder builder = new MultipartBuilder().type(MultipartBuilder.FORM);
////        if (tagId!=null){
////            builder.addPart(Headers.of("Content-Disposition", "form-data;  tagid=\"" + tagId
////                            + "\"",),
////                    RequestBody.create(null, tagId));
////        }
//        if (file!=null && tagId!=null){
//            RequestBody requestBody = RequestBody.create(MediaType.parse
//                    ("multipart/form-data"), file);
//            //添加file input块的数据
//            builder.addPart(Headers.of("Content-Disposition",
//                    "form-data; tagid=\"" + tagId), requestBody);
//        }
//        return builder.build();
//    }

//    private RequestBody buildRequestByteBody(Map<String,byte[]> map){
//        MultipartBuilder builder = new MultipartBuilder().type(MultipartBuilder.FORM);
...
//                                "\""), requestBody);
                builder.addPart(Headers.of("Content-Disposition", "form-data; name=\"file\";filename=\"" + fileName + "\""), RequestBody.create(MediaType.parse("image/jpeg"),file)
                ).build();
    ...
    //获取网址中的数据，进行Gson解析
    public static void loadNetworkData(final Context context, String url, Callback callback) {
        OkHttpClientHelper.getDataAsync(context, url, callback, "detail");
    }
}